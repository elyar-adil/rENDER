...
class Declaration:
    ...
    def __init__(self, prop: str, value: str, important: bool = False) -> None:
        self.property  = prop
        self.value     = value
...
class QualifiedRule:
    ...
    def __init__(self, prelude: str, declarations: list[Declaration]) -> None:
...
class Stylesheet:
    ...
    def __init__(self, rules: list[QualifiedRule | AtRule]) -> None:
        self.rules = rules
...
def parse_declaration_block(css: str) -> list[Declaration]:
    """Parse declarations from the *content* of a { } block."""
    parser = _Parser(css)
    return parser.parse_declaration_list()


def parse_inline_style(css: str) -> dict[str, str]:
...
class _Parser:
    ...
    def _skip_whitespace_and_semicolons(self) -> None:
    ...
    def _consume_rule_list_in_block(self) -> list[QualifiedRule | AtRule]:
        rules: list[QualifiedRule | AtRule] = []
        while True:
            self._skip_whitespace()
            tok = self._current()
    ...
    def _consume_declaration_list_in_block(self) -> list[Declaration]:
    ...
    def parse_declaration_list(self) -> list[Declaration]:
