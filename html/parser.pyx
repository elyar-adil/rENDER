...
class StartTagToken:
    ...
    def __init__(self, tag_name: str, attributes: dict[str, str] | None = None, self_closing: bool = False) -> None:
...
OPTIONAL_CLOSE: dict[str, frozenset[str]] = {
    'li': frozenset({'li'}),
...
class TreeBuilder:
    ...
    _html_element: Element | None
    _head_element: Element | None
    _body_element: Element | None
    _in_rawtext: bool
    _rawtext_tag: str | None
    ...
    def _ensure_html_body(self) -> None:
    ...
    def _process_start_tag(self, token: StartTagToken) -> None:
        tag = token.tag_name
    ...
    def _process_end_tag(self, token: EndTagToken) -> None:
        tag = token.tag_name
    ...
    def process_token(self, token: Any) -> None:
    ...
    def build(self, tokens: list[Any]) -> Document:
        for token in tokens:
