...
impl JsRuntime {
    pub(in crate::js::runtime) fn dispatch_regexp_native(
        &mut self,
        dom: &mut Dom,
...
impl JsRuntime {
    ...
    pub(in crate::js::runtime) fn construct_regex(
        &mut self,
        pattern: &str,
        flags: &str,
    ) -> Result<ObjectId, JsError> {
        let compiled = crate::js::regex::compile(pattern, flags).map_err(|error| {
            JsError::syntax(
    ...
    pub(in crate::js::runtime) fn regex_index(&self, object: ObjectId) -> Result<usize, JsError> {
    ...
    pub(in crate::js::runtime) fn coerce_pattern_argument(
        &mut self,
        value: &JsValue,
    ...
    pub(in crate::js::runtime) fn regex_exec_value(
        &mut self,
        index: usize,
        input: &[char],
        start: usize,
    ...
    pub(in crate::js::runtime) fn regexp_exec(
        &mut self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn regexp_test(
        &mut self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn regexp_to_string(
        &mut self,
        receiver: ObjectId,
    ) -> Result<JsValue, JsError> {
        let index = self.regex_index(receiver)?;
