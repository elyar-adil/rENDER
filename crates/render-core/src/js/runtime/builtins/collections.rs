...
use crate::js::value::CollectionKind;
use crate::js::value::NativeFunction;
use crate::js::value::ObjectHost;

impl JsRuntime {
    pub(in crate::js::runtime) fn dispatch_collections_native(
        &mut self,
        dom: &mut Dom,
...
#[derive(Clone, Copy)]
pub(in crate::js::runtime) enum CollectionView {
    Keys,
    Values,
    Entries,
}
...
impl JsRuntime {
    pub(in crate::js::runtime) fn collection_constructor(
        &mut self,
        dom: &mut Dom,
    ...
    pub(in crate::js::runtime) fn collection_get(
        &self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn collection_store(
        &mut self,
        receiver: ObjectId,
        key: JsValue,
        value: JsValue,
    ...
    pub(in crate::js::runtime) fn collection_has(
        &self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn collection_delete(
        &mut self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn collection_clear(
        &mut self,
        receiver: ObjectId,
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn collection_for_each(
        &mut self,
        dom: &mut Dom,
        receiver: ObjectId,
        arguments: &[JsValue],
    ...
    pub(in crate::js::runtime) fn collection_iterator(
        &mut self,
        receiver: ObjectId,
        view: CollectionView,
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn collection_iterator_next(
        &mut self,
        receiver: ObjectId,
    ) -> Result<JsValue, JsError> {
        let value = {
