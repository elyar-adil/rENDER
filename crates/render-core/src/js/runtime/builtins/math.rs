...
impl JsRuntime {
    pub(in crate::js::runtime) fn dispatch_math_native(
        &mut self,
        dom: &mut Dom,
...
pub(in crate::js::runtime) fn js_math_round(value: f64) -> f64 {
...
impl JsRuntime {
    pub(in crate::js::runtime) fn math_unary(
        arguments: &[JsValue],
    ...
    pub(in crate::js::runtime) fn math_min_max(
        arguments: &[JsValue],
        identity: f64,
    ...
    pub(in crate::js::runtime) fn math_pow(arguments: &[JsValue]) -> Result<JsValue, JsError> {
