...
impl JsRuntime {
    pub(in crate::js::runtime) fn dispatch_date_native(
        &mut self,
        dom: &mut Dom,
...
pub(in crate::js::runtime) fn days_from_civil(year: i32, month: i32, day: i32) -> i64 {
...
pub(in crate::js::runtime) const DATE_WEEKDAYS: [&str; 7] =
    ["Thu", "Fri", "Sat", "Sun", "Mon", "Tue", "Wed"];

pub(in crate::js::runtime) const DATE_MONTHS: [&str; 12] = [
    "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec",
];

impl JsRuntime {
    pub(in crate::js::runtime) fn require_date_value(
        &self,
        receiver: ObjectId,
    ) -> Result<f64, JsError> {
        match self.realm.host(receiver) {
    ...
    pub(in crate::js::runtime) fn date_getter(function: NativeFunction, ms: f64) -> JsValue {
        if !ms.is_finite() {
    ...
    pub(in crate::js::runtime) fn date_components(
        ms: f64,
    ...
    pub(in crate::js::runtime) fn date_from_constructor_arguments(
        arguments: &[JsValue],
    ) -> Result<f64, JsError> {
        match arguments {
    ...
    pub(in crate::js::runtime) fn date_from_utc_arguments(
        arguments: &[JsValue],
    ) -> Result<f64, JsError> {
    ...
    pub(in crate::js::runtime) fn parse_date_string(value: &str) -> Option<f64> {
    ...
    pub(in crate::js::runtime) fn format_date_iso(ms: f64) -> String {
    ...
    pub(in crate::js::runtime) fn now_ms() -> f64 {
        #[allow(
            clippy::cast_precision_loss,
    ...
    pub(in crate::js::runtime) fn monotonic_now_ms() -> f64 {
        pub(in crate::js::runtime) static START: std::sync::OnceLock<std::time::Instant> =
    ...
    pub(in crate::js::runtime) fn format_date_utc(ms: f64) -> String {
