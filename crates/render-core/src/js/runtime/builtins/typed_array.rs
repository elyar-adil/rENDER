...
use crate::js::value::TypedArrayKind;
use crate::js::value::TypedBuffer;

impl JsRuntime {
    pub(in crate::js::runtime) fn dispatch_typed_array_native(
        &mut self,
        dom: &mut Dom,
...
impl JsRuntime {
    pub(in crate::js::runtime) fn typed_array_constructor(
        &mut self,
        dom: &mut Dom,
    ...
    pub(in crate::js::runtime) fn typed_array_source_values(
        &mut self,
        dom: &mut Dom,
        source: &JsValue,
    ...
    pub(in crate::js::runtime) fn typed_array_from(
        &mut self,
        dom: &mut Dom,
        constructor: ObjectId,
        kind: TypedArrayKind,
    ...
    pub(in crate::js::runtime) fn create_typed_array(
        &mut self,
        kind: TypedArrayKind,
        length: usize,
    ...
    pub(in crate::js::runtime) fn create_typed_array_from_values(
        &mut self,
        kind: TypedArrayKind,
        values: &[f64],
        prototype: Option<ObjectId>,
    ...
    pub(in crate::js::runtime) fn typed_array_host(
        &self,
        receiver: ObjectId,
    ...
    pub(in crate::js::runtime) fn typed_array_elements(
        &self,
        receiver: ObjectId,
    ) -> Result<Vec<f64>, JsError> {
    ...
    pub(in crate::js::runtime) fn typed_array_set(
        &mut self,
        dom: &mut Dom,
        receiver: ObjectId,
        arguments: &[JsValue],
    ...
    pub(in crate::js::runtime) fn typed_array_derived_prototype(
        &self,
        receiver: ObjectId,
    ) -> Option<ObjectId> {
        self.realm
    ...
    pub(in crate::js::runtime) fn typed_array_subarray(
        &mut self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn typed_array_slice(
        &mut self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn typed_range(
        arguments: &[JsValue],
        length: usize,
    ...
    pub(in crate::js::runtime) fn typed_array_fill(
        &mut self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn typed_array_index_of(
        &mut self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn typed_from_index(
    ...
    pub(in crate::js::runtime) fn typed_array_includes(
        &self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn typed_array_for_each(
        &mut self,
        dom: &mut Dom,
        receiver: ObjectId,
        callback: ObjectId,
    ...
    pub(in crate::js::runtime) fn typed_array_map_or_filter(
        &mut self,
        dom: &mut Dom,
        receiver: ObjectId,
        callback: ObjectId,
    ...
    pub(in crate::js::runtime) fn typed_array_join(
        &mut self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn typed_index(
        &mut self,
        value: &JsValue,
    ) -> Result<usize, JsError> {
        let number = to_number(value)?;
