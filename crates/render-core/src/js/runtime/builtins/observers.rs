...
use crate::js::value::MutationWatch;
use crate::js::value::NativeFunction;
use crate::js::value::ObjectHost;

impl JsRuntime {
    pub(in crate::js::runtime) fn dispatch_observers_native(
        &mut self,
        dom: &mut Dom,
...
impl JsRuntime {
    pub(in crate::js::runtime) fn intersection_observer_constructor(
        &mut self,
    ...
    pub(in crate::js::runtime) fn intersection_observe(
        &mut self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn intersection_unobserve(
        &mut self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn intersection_disconnect(
        &mut self,
        receiver: ObjectId,
    ) -> Result<JsValue, JsError> {
        let Some(ObjectHost::IntersectionObserver { targets, .. }) = self.realm.host_mut(receiver)
    ...
    pub(in crate::js::runtime) fn intersection_take_records(
        &mut self,
        receiver: ObjectId,
    ) -> Result<JsValue, JsError> {
        if !matches!(
    ...
    pub(in crate::js::runtime) fn mutation_observer_constructor(
        &mut self,
        constructor: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn mutation_observe(
        &mut self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn mutation_disconnect(
        &mut self,
        receiver: ObjectId,
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn mutation_take_records(
        &mut self,
        receiver: ObjectId,
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn queue_mutation_deliveries(&mut self, dom: &mut Dom) {
    ...
    pub(in crate::js::runtime) fn notify_mutation_observer(
        &mut self,
        dom: &mut Dom,
        observer: ObjectId,
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn mutation_record_value(
        &mut self,
        record: &crate::dom::MutationRecord,
    ) -> JsValue {
    ...
    pub(in crate::js::runtime) fn has_ancestor(dom: &Dom, node: NodeId, ancestor: NodeId) -> bool {
    ...
    pub(in crate::js::runtime) fn queue_intersection_observer(&mut self, observer: ObjectId) {
        if !self
            .pending_microtasks
            .iter()
    ...
    pub(in crate::js::runtime) fn queue_intersection_observers(&mut self) {
    ...
    pub(in crate::js::runtime) fn notify_intersection_observer(
        &mut self,
        dom: &mut Dom,
        observer: ObjectId,
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn intersection_entry(
        &mut self,
        target: NodeId,
    ) -> Result<JsValue, JsError> {
