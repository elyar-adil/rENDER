...
use crate::js::runtime::convert::same_value_zero;
use crate::js::runtime::convert::strict_equal;
use crate::js::runtime::convert::to_number;
use crate::js::value::NativeFunction;
use crate::js::value::ObjectHost;

impl JsRuntime {
    pub(in crate::js::runtime) fn dispatch_array_native(
        &mut self,
        dom: &mut Dom,
...
pub(in crate::js::runtime) fn array_index(property: &str) -> Option<u32> {
    let index = property.parse::<u32>().ok()?;
    (index.to_string() == property && index < u32::MAX).then_some(index)
}

impl JsRuntime {
    pub(in crate::js::runtime) fn array_constructor(
        &mut self,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    /// element pool bound.
    pub(in crate::js::runtime) fn array_like_length(
        &mut self,
        dom: &mut Dom,
        object: ObjectId,
    ...
    pub(in crate::js::runtime) fn array_elements_for(&mut self, object: ObjectId) -> Vec<JsValue> {
    ...
    pub(in crate::js::runtime) fn create_array_from_values(
        &mut self,
        values: &[JsValue],
    ...
    pub(in crate::js::runtime) fn array_push(
        &mut self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn array_pop(
        &mut self,
        receiver: ObjectId,
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn array_join(
        &self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn array_elements(
        &self,
        receiver: ObjectId,
    ...
    pub(in crate::js::runtime) fn array_element(
        &self,
        receiver: ObjectId,
        index: u32,
    ) -> Option<JsValue> {
    ...
    pub(in crate::js::runtime) fn set_array_elements(
        &mut self,
        receiver: ObjectId,
        values: &[JsValue],
    ) -> Result<(), JsError> {
    ...
    pub(in crate::js::runtime) fn array_index_of(
        &self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn array_slice(
        &mut self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn array_splice(
        &mut self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn array_reverse(
        &mut self,
        receiver: ObjectId,
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn array_sort(
        &mut self,
        dom: &mut Dom,
        receiver: ObjectId,
        arguments: &[JsValue],
    ...
    pub(in crate::js::runtime) fn sort_order(
        &mut self,
        dom: &mut Dom,
    ...
    pub(in crate::js::runtime) fn array_concat(
        &mut self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn array_shift(
        &mut self,
        receiver: ObjectId,
    ) -> Result<JsValue, JsError> {
        let mut elements = self.array_elements(receiver)?;
    ...
    pub(in crate::js::runtime) fn array_unshift(
        &mut self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn array_iterate_with(
        &mut self,
        dom: &mut Dom,
        receiver: ObjectId,
        callback: ObjectId,
    ...
    pub(in crate::js::runtime) fn array_some(
        &mut self,
        dom: &mut Dom,
        receiver: ObjectId,
        callback: ObjectId,
    ...
    pub(in crate::js::runtime) fn array_from(
        &mut self,
        dom: &mut Dom,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn array_find(
        &mut self,
        dom: &mut Dom,
        receiver: ObjectId,
        arguments: &[JsValue],
    ...
    pub(in crate::js::runtime) fn array_every(
        &mut self,
        dom: &mut Dom,
        receiver: ObjectId,
        arguments: &[JsValue],
    ...
    pub(in crate::js::runtime) fn array_includes(
        &mut self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn array_reduce(
        &mut self,
        dom: &mut Dom,
        receiver: ObjectId,
        arguments: &[JsValue],
    ...
    pub(in crate::js::runtime) fn array_length(&self, object: ObjectId) -> Result<u32, JsError> {
        let value = self
            .realm
            .get_property(object, "length")
    ...
    pub(in crate::js::runtime) fn set_array_length_value(
        &mut self,
        object: ObjectId,
        value: &JsValue,
    ) -> Result<(), JsError> {
    ...
    pub(in crate::js::runtime) fn set_array_length(
        &mut self,
        object: ObjectId,
        length: u32,
    ) -> Result<(), JsError> {
