...
impl JsRuntime {
    pub(in crate::js::runtime) fn dispatch_url_native(
        &mut self,
        dom: &mut Dom,
...
impl JsRuntime {
    pub(in crate::js::runtime) fn url_constructor(
        &mut self,
        ...
        for (name, value) in crate::js::value::location_components(&parsed) {
            self.realm
    ...
    pub(in crate::js::runtime) fn url_search_params_constructor(
        &mut self,
        constructor: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn url_to_string(&self, receiver: &JsValue) -> JsValue {
        match receiver {
            JsValue::Object(object) => match self.realm.host(*object) {
    ...
    pub(in crate::js::runtime) fn url_search_params_method(
        &mut self,
        receiver: &JsValue,
        function: NativeFunction,
        arguments: &[JsValue],
    ...
    pub(in crate::js::runtime) fn percent_encode(text: &str, keep_uri: bool) -> String {
    ...
    pub(in crate::js::runtime) fn percent_decode(text: &str) -> Option<String> {
