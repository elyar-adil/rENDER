...
//! [`PendingFetch`](crate::js::runtime::types::PendingFetch); the embedding
...
use crate::js::runtime::builtins::json::JsonParser;
...
use crate::js::value::XhrResponse;
use crate::js::value::XmlHttpRequestState;
use url::Url;

impl JsRuntime {
    pub(in crate::js::runtime) fn dispatch_fetch_native(
        &mut self,
        dom: &mut Dom,
    ...
    pub(in crate::js::runtime) fn build_response_value(
        &mut self,
    ...
    pub(in crate::js::runtime) fn response_constructor(
        &mut self,
    ...
    pub(in crate::js::runtime) fn xml_http_request_constructor(
        &mut self,
        constructor: ObjectId,
    ) -> Result<JsValue, JsError> {
        let prototype = self.constructor_prototype(constructor)?;
    ...
    pub(in crate::js::runtime) fn complete_xml_http_request(
        &mut self,
        receiver: ObjectId,
