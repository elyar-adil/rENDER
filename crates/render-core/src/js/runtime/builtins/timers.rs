...
use crate::js::runtime::types::TimerEntry;
use crate::js::runtime::types::TimerKind;
use crate::js::runtime::types::TimerRequest;
...
pub(in crate::js::runtime) fn optional_timer_id(value: &JsValue) -> Option<u64> {
    match value {
...
impl JsRuntime {
    pub(in crate::js::runtime) fn register_timer_entry(
        &mut self,
        callback: ObjectId,
        delay_ms: f64,
        kind: TimerKind,
    ...
    pub(in crate::js::runtime) fn register_timer(
        &mut self,
    ...
    pub(in crate::js::runtime) fn cancel_timer(&mut self, arguments: &[JsValue]) -> JsValue {
