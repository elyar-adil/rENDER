...
impl JsRuntime {
    pub(in crate::js::runtime) fn dispatch_style_native(
        &mut self,
        dom: &mut Dom,
...
impl JsRuntime {
    ...
    pub(in crate::js::runtime) fn write_inline_declarations(
        dom: &mut Dom,
        node: NodeId,
    ...
    pub(in crate::js::runtime) fn style_get_property(
        &mut self,
        dom: &Dom,
        receiver: ObjectId,
        arguments: &[JsValue],
    ...
    pub(in crate::js::runtime) fn style_set_property(
        &mut self,
        dom: &mut Dom,
        receiver: ObjectId,
        arguments: &[JsValue],
    ...
    pub(in crate::js::runtime) fn style_remove_property(
        &mut self,
        dom: &mut Dom,
        receiver: ObjectId,
        arguments: &[JsValue],
    ...
    pub(in crate::js::runtime) fn style_item(
        &mut self,
        dom: &Dom,
        receiver: ObjectId,
        arguments: &[JsValue],
    ...
    pub(in crate::js::runtime) fn require_style_declaration(
        &self,
        object: ObjectId,
