...
impl JsRuntime {
    pub(in crate::js::runtime) fn dispatch_events_native(
        &mut self,
        dom: &mut Dom,
...
impl JsRuntime {
    pub(in crate::js::runtime) fn event_constructor(
        &mut self,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn event_target_node(
        &self,
        receiver: ObjectId,
    ...
    pub(in crate::js::runtime) fn add_event_listener(
        &mut self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn remove_event_listener(
        &mut self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn dispatch_event(
        &mut self,
        dom: &mut Dom,
        receiver: ObjectId,
        arguments: &[JsValue],
    ...
    pub(in crate::js::runtime) fn add_window_listener(
        &mut self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn remove_window_listener(
        &mut self,
        receiver: ObjectId,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
    ...
    pub(in crate::js::runtime) fn dispatch_prepared_event(
        &mut self,
        dom: &mut Dom,
        target: NodeId,
        event: ObjectId,
    ...
    pub(in crate::js::runtime) fn event_prevent_default(&mut self, receiver: ObjectId) -> JsValue {
        let cancelable = self
            .realm
