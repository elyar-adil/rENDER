...
use crate::js::runtime::types::ConsoleLevel;
use crate::js::runtime::types::ConsoleMessage;
use crate::js::runtime::types::JsMicrotask;
use crate::js::runtime::types::MAX_BUFFERED_CONSOLE_MESSAGES;
...
impl JsRuntime {
    pub(in crate::js::runtime) fn dispatch_residual_native(
        &mut self,
        dom: &mut Dom,
...
impl JsRuntime {
    ...
    pub(in crate::js::runtime) fn console_write(
        &mut self,
        function: NativeFunction,
        arguments: &[JsValue],
    ) -> Result<JsValue, JsError> {
